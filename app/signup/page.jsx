...
import { Mail, Lock, ArrowRight, Github, ShieldCheck, UserPlus, Building2 } from 'lucide-react';
...
export default function SignupPage() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            // 1. Create user via backend API (auto-confirmed)
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 selection:bg-blue-100">
            <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500 text-sm font-medium">Start your governance journey with Verytis</p>
                </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <div className="pt-2">
                            <p className="text-[10px] text-slate-500 mb-4 leading-relaxed">
                                ...
                                <Link href="#" className="underline hover:text-blue-600">Terms of Service</Link> and{' '}
                ...
                <p className="text-center text-sm text-slate-500">
                    ...
                    <Link href="/login" className="font-bold text-blue-600 hover:text-blue-700 transition-colors underline decoration-blue-200 underline-offset-4 decoration-2 hover:decoration-blue-600">
                        Sign in
                    </Link>
                </p>
            </div>
